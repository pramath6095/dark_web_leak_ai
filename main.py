...
Examples:
  ...
  python main.py -t 10 "credential dump"    # 10 threads for faster scraping
        """
    )
    parser.add_argument(
        "query",
    ...
    parser.add_argument(
        ...
        default=3,
        metavar="N",
        help="Number of concurrent threads (default: 3). Each thread uses a different Tor circuit."
    )
    parser.add_argument(
        "-l", "--limit",
        type=int,
